...
#define MMCSD_GET_CARD_BUSWIDTH(sdcard) \
	((((sdcard.busWidth) & 0x0FU) == 0x01) ? 0x1 : ((((sdcard).busWidth & 0x04U) == 0x04U) ? 0x04U : 0xFFU))
 ...
 */
#define MMCSD_GET_CARD_FRE(sdcard) (((sdcard.tranSpeed) == 0x5AU) ? 50U : (((sdcard.tranSpeed) == 0x32U) ? 25U : 0U))
...
#define EVENT_DMA_COMPLETE Event_Id_02
	...
	EDMA3_DRV_PaRAMRegs txPaRAM;
	EDMA3_DRV_PaRAMRegs rxPaRAM;
...
void sd_controller_init_dma(sd_controller_t *this, EDMA3_DRV_Handle hEdma, uint32_t dmaTx, uint32_t dmaRx);
