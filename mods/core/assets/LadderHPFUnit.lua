...
function LadderHPFUnit:onLoadGraph(channelCount)
  local filter
  if channelCount == 2 then
    filter = self:addObject("filter", libcore.StereoLadderHPF())
...
function LadderHPFUnit:onLoadViews(objects, branches)
  local controls = {}
